    ...
    return (
        <>
            <div className={`block_title`}>
                ...
                <Framework title={t('framework_PHP.title')} description={t("framework_PHP.description")}/>
                <Framework title={t('framework_NODEJS.title')} description={t("framework_NODEJS.description")}/>
                <Framework title={t('framework_C#.title')} description={t("framework_C#.description")}/>
            </div>
        </>
    )
}
