    ...
    return (
        <Box>
            <div className={`block_title`}>
                ...
                <Framework title={t('framework_JS.title')} description={t("framework_JS.description")}/>
                <Framework title={t('framework_UI.title')} description={t("framework_UI.description")}/>
            </div>
